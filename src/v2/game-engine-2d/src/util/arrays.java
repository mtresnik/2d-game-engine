...
import static util.reflection.castNum;
import static util.reflection.classOf;
import static util.reflection.findClosestCommonSuper;
import static util.reflection.isParent;
import static util.reflection.parseNum;
import static util.reflection.stringOf;
import static util.strings.concatDelim;
